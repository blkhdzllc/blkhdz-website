...
# Added 'img' field to ensure no broken images due to extensions or custom names.
LEGO_DATA = [
    ...
    {"id": "31167", "name": "Haunted Mansion 3-in-1 Seasonal Bundle", "w": 3.5, "b": "15x14x3", "url": "https://www.ebay.com/itm/117037598121", "feat": True, "img": "31167.jpg"},
...
DIECAST_DATA = [
    {"id": "MGT00773-C", "name": "Mazda RX-7 LB-Silhouette #41 [CHASE BUNDLE]", "p": 95.00, "stat": "LIMITED CHASE BUNDLE", "url": "https://www.ebay.com/itm/117098917766", "feat": True, "img": "mgt00773-C.jpg"},
    ...
    {"id": "MGT00716", "name": "Cadillac V-Series.R #2 Le Mans Blue", "p": 16.99, "stat": "LIMITED EDITION", "url": "https://www.ebay.com/itm/117081912634", "feat": False, "img": "MGT00716.png"},
...
def run():
    output = {"last_updated": datetime.datetime.now().strftime("%B %d, %Y"), "lego": [], "diecast": []}
    ...
    for item in LEGO_DATA:
        ...
        output["lego"].append({
            ...
            "featured": item['feat'], "shipping": f"BOX: {item['b']} | WT: {item['w']} LBS"
        })
    ...
    for item in DIECAST_DATA:
        output["diecast"].append({
            ...
            "price": f"{item['p']:.2f}",
            "url": item['url'] + "?mkcid=1&mkrid=711-53200-19255-0&campid=5339141674&toolid=10001&mkevt=1",
            "featured": item['feat'], "status": item['stat']
        })
