...
def get_market_price(set_num):
    ...
    # STRICTOR SEARCH: US Only, New, Excludes high-price custom builds
...
def run():
    ...
    for item in LEGO_LIST:
        ...
        final_inventory.append({
            ...
            "type": "2026" if "2026" in item['name'] or "42224" in item['id'] else "elite"
        })
        time.sleep(1)
